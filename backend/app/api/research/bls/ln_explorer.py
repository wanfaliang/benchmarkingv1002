...
router = APIRouter(prefix="/api/research/bls/ln", tags=["BLS LN Explorer"])
...
def get_series(
    ...
    return LNSeriesListResponse(
        ...
        limit=limit,
        offset=offset,
        series=[LNSeriesInfo.model_validate(s) for s in series]
    )
...
def get_occupation_analysis(
    ...
    # Note: These are placeholder series IDs - actual occupation-specific series would need to be identified
    occupation_series_map = {
        "Management, professional, and related": "LNS14000000",
        "Service occupations": "LNS14000000",
        "Sales and office occupations": "LNS14000000",
        "Natural resources, construction, and maintenance": "LNS14000000",
        "Production, transportation, and material moving": "LNS14000000",
    }

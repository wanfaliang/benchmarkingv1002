...
export interface LACoordinates {
  lat: number;
  lng: number;
  type?: 'state' | 'metro';
}
...
export const stateCoordinates: Record<string, LACoordinates> = {
 ...
 */
export function getLAAreaCoordinates(areaCode: string, areaName?: string): LACoordinates | null {

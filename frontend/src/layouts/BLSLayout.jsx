...
const blsSurveys = [
  ...
  { id: 'cw', label: 'CW', title: 'CPI for Urban Wage Earners', available: false },
  { id: 'ap', label: 'AP', title: 'Average Price', available: false },
  // Employment
  { id: 'ce', label: 'CE', title: 'Employment Statistics', available: true },
  { id: 'la', label: 'LA', title: 'Local Area Unemployment', available: true },
  { id: 'sm', label: 'SM', title: 'State & Metro Employment', available: false },
  { id: 'jt', label: 'JT', title: 'Job Openings (JOLTS)', available: false },
  { id: 'oe', label: 'OE', title: 'Occupational Employment', available: false },
  // Labor Force
  { id: 'ln', label: 'LN', title: 'Labor Force Statistics', available: true },
  { id: 'ec', label: 'EC', title: 'Employment Cost Index', available: false },
  // Industry / Producer Prices
  { id: 'pc', label: 'PC', title: 'PPI - Industry', available: true },
  { id: 'wp', label: 'WP', title: 'PPI - Commodity', available: false },
  { id: 'pr', label: 'PR', title: 'Productivity', available: false },
  // International
  { id: 'ei', label: 'EI', title: 'Import/Export Price', available: false },
  // Other
  { id: 'ws', label: 'WS', title: 'Work Stoppage', available: false },
  { id: 'cs', label: 'CS', title: 'Census of Fatal Injuries', available: false },
  { id: 'sh', label: 'SH', title: 'Injuries & Illnesses', available: false },
  { id: 'tu', label: 'TU', title: 'Time Use Survey', available: false },
  { id: 'cx', label: 'CX', title: 'Consumer Expenditure', available: false },
];

export default function BLSLayout() {

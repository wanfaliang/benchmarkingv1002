...
interface ViewQueryDialogProps {
  query: SavedQuery;
  onClose: () => void;
}
...
export default function ViewQueryDialog({ query, onClose }: ViewQueryDialogProps): React.ReactElement | null {
        ...
        <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="px-6 py-4 space-y-4 overflow-y-auto flex-1">
            ...
            <div className="space-y-4">
              ...
              {/* Pagination */}
              {(config.limit || (config.offset && config.offset > 0)) && (
                <div>
                  ...
                  <div className="px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-sm text-slate-700">
                    ...
                    {config.offset && config.offset > 0 && <div>Offset: {config.offset} rows</div>}
                  </div>
                </div>
              )}
            </div>

...
/**
 * ScatterChartView.jsx - Scatter Plot Component
 * 
 * Features:
 * - Two-dimensional scatter plot
 * - Multi-company comparison with colors
 * - Bubble size option (future)
...
export default function ScatterChartView({ data, xAxis, yAxis, groupBy, showLegend, showGrid }) {
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-lg p-3">
        <div className="text-sm space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-slate-900">{point.x}</span>
          </div>
          <div className="flex items-center gap-2">

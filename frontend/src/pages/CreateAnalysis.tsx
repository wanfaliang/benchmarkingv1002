import React, { useState, useMemo, KeyboardEvent, ChangeEvent, FormEvent } from 'react';
...
import type { Company, CreateAnalysisPayload } from '../types';

/**
 * CreateAnalysis.tsx - Professional Analysis Creation Interface
 *
 * Features:
...
const CreateAnalysis: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(error.response?.data?.detail || 'Failed to create analysis');
    } finally {
      setSubmitting(false);
    }
  };
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={analysisName}
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setAnalysisName(e.target.value)}
